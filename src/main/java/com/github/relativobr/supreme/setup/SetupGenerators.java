...
public class SetupGenerators {
  ...
  public static void setup(Supreme sup) {
    ...
    if (getSupremeOptions().isEnableTech()) {
      ...
      new GeneratorMob(SupremeItems.GENERATOR_MOB_BASIC, GeneratorMob.RECIPE_GENERATOR_MOB_BASIC).setBuffer(
      ...
      new GeneratorMob(SupremeItems.GENERATOR_MOB_MEDIUM, GeneratorMob.RECIPE_GENERATOR_MOB_MEDIUM).setBuffer(
      ...
      new GeneratorMob(SupremeItems.GENERATOR_MOB_ADVANCED, GeneratorMob.RECIPE_GENERATOR_MOB_ADVANCED).setBuffer(
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.BASIC_IGNIS_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.IGNIS_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.BASIC_VENTUS_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.VENTUS_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.BASIC_AQUA_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.AQUA_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.BASIC_LUX_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.LUX_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.BASIC_LUMIUM_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.LUMIUM_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.THORNIUM_GENERATOR,
    ...
    new EnergyGenerator(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.SUPREME_GENERATOR,
    ...
    new EnergyCapacitor(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.AURUM_CAPACITOR,
        SupremeCapacitor.MACHINE_AURUM_CAPACITOR,
        getValueGeneratorsWithLimit(SupremeCapacitor.AURUM_CAPACITY)).register(sup);

    new EnergyCapacitor(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.TITANIUM_CAPACITOR,
        SupremeCapacitor.MACHINE_TITANIUM_CAPACITOR,
        getValueGeneratorsWithLimit(SupremeCapacitor.TITANIUM_CAPACITY)).register(sup);

    new EnergyCapacitor(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.ADAMANTIUM_CAPACITOR,
    ...
    new EnergyCapacitor(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.THORNIUM_CAPACITOR,
        SupremeCapacitor.MACHINE_THORNIUM_CAPACITOR,
        getValueGeneratorsWithLimit(SupremeCapacitor.THORNIUM_CAPACITY)).register(sup);

    new EnergyCapacitor(ItemGroups.ELECTRIC_CATEGORY, SupremeItems.SUPREME_CAPACITOR,
