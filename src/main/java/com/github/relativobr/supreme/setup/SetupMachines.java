...
public class SetupMachines {
  ...
  public static void setup(Supreme sup) {
    ...
    new ElectricCoreFabricator(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CORE_MACHINE,
        RecipeType.ENHANCED_CRAFTING_TABLE, ElectricCoreFabricator.RECIPE_ELECTRIC_CORE_MACHINE).setMachineIdentifier(
            SupremeItems.ELECTRIC_CORE_MACHINE.getItemId())
    ...
    new ElectricCoreFabricator(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CORE_MACHINE_II,
        RecipeType.ENHANCED_CRAFTING_TABLE,
        ElectricCoreFabricator.RECIPE_ELECTRIC_CORE_MACHINE_II).setMachineIdentifier(
            SupremeItems.ELECTRIC_CORE_MACHINE_II.getItemId())
    ...
    new ElectricCoreFabricator(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CORE_MACHINE_III,
        RecipeType.ENHANCED_CRAFTING_TABLE,
        ElectricCoreFabricator.RECIPE_ELECTRIC_CORE_MACHINE_III).setMachineIdentifier(
            SupremeItems.ELECTRIC_CORE_MACHINE_III.getItemId())
    ...
    new MobCollector(ItemGroups.MACHINES_CATEGORY, SupremeItems.MOB_COLLECTOR_MACHINE,
    ...
    new MobCollector(ItemGroups.MACHINES_CATEGORY, SupremeItems.MOB_COLLECTOR_MACHINE_II,
    ...
    new MobCollector(ItemGroups.MACHINES_CATEGORY, SupremeItems.MOB_COLLECTOR_MACHINE_III,
    ...
    new VirtualGarden(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_GARDEN_MACHINE,
    ...
    new VirtualGarden(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_GARDEN_MACHINE_II,
    ...
    new VirtualGarden(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_GARDEN_MACHINE_III,
    ...
    new ForgeIngot(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_INGOT_MACHINE, RecipeType.ENHANCED_CRAFTING_TABLE,
        ForgeIngot.RECIPE_FORGE_INGOT_MACHINE).setMachineIdentifier(SupremeItems.FORGE_INGOT_MACHINE.getItemId())
    ...
    new ForgeIngot(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_INGOT_MACHINE_II, RecipeType.ENHANCED_CRAFTING_TABLE,
        ForgeIngot.RECIPE_FORGE_INGOT_MACHINE_II).setMachineIdentifier(SupremeItems.FORGE_INGOT_MACHINE_II.getItemId())
    ...
    new ForgeIngot(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_INGOT_MACHINE_III, RecipeType.ENHANCED_CRAFTING_TABLE,
        ForgeIngot.RECIPE_FORGE_INGOT_MACHINE_III).setMachineIdentifier(SupremeItems.FORGE_INGOT_MACHINE_III.getItemId())
    ...
    new ForgeMagical(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_MAGICAL_MACHINE,
        RecipeType.ENHANCED_CRAFTING_TABLE, ForgeMagical.RECIPE_FORGE_MAGICAL_MACHINE).setTimeProcess(15)
        .setMachineIdentifier(SupremeItems.FORGE_MAGICAL_MACHINE.getItemId())
        .setMachineRecipes(ForgeMagical.getAllRecipe()).setTimeProcess(15).setProcessingSpeed(1).setCapacity(1000)
        .setEnergyConsumption(20).register(sup);

    new ForgeMagical(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_MAGICAL_MACHINE_II,
        RecipeType.ENHANCED_CRAFTING_TABLE, ForgeMagical.RECIPE_FORGE_MAGICAL_MACHINE_II).setTimeProcess(15)
        .setMachineIdentifier(SupremeItems.FORGE_MAGICAL_MACHINE_II.getItemId())
        .setMachineRecipes(ForgeMagical.getAllRecipe()).setTimeProcess(15).setProcessingSpeed(5).setCapacity(5000)
        .setEnergyConsumption(100).register(sup);

    new ForgeMagical(ItemGroups.MACHINES_CATEGORY, SupremeItems.FORGE_MAGICAL_MACHINE_III,
        RecipeType.ENHANCED_CRAFTING_TABLE, ForgeMagical.RECIPE_FORGE_MAGICAL_MACHINE_III).setMachineIdentifier(
            SupremeItems.FORGE_MAGICAL_MACHINE_III.getItemId()).setMachineRecipes(ForgeMagical.getAllRecipe())
        .setTimeProcess(15).setProcessingSpeed(15).setCapacity(15000).setEnergyConsumption(300).register(sup);

    new MagicAltar(ItemGroups.MACHINES_CATEGORY, SupremeItems.MAGIC_ALTAR_MACHINE, RecipeType.ENHANCED_CRAFTING_TABLE,
        MagicAltar.RECIPE_MAGIC_ALTAR_MACHINE).setMachineIdentifier(SupremeItems.MAGIC_ALTAR_MACHINE.getItemId())
        .setMachineRecipes(MagicAltar.getAllRecipe()).setTimeProcess(15).setProcessingSpeed(1).setCapacity(40)
        .setEnergyConsumption(20).register(sup);

    new MagicAltar(ItemGroups.MACHINES_CATEGORY, SupremeItems.MAGIC_ALTAR_MACHINE_II, RecipeType.ENHANCED_CRAFTING_TABLE,
        MagicAltar.RECIPE_MAGIC_ALTAR_MACHINE_II).setMachineIdentifier(SupremeItems.MAGIC_ALTAR_MACHINE_II.getItemId())
        .setMachineRecipes(MagicAltar.getAllRecipe()).setTimeProcess(15).setProcessingSpeed(5).setCapacity(200)
        .setEnergyConsumption(100).register(sup);

    new MagicAltar(ItemGroups.MACHINES_CATEGORY, SupremeItems.MAGIC_ALTAR_MACHINE_III, RecipeType.ENHANCED_CRAFTING_TABLE,
        MagicAltar.RECIPE_MAGIC_ALTAR_MACHINE_III).setMachineIdentifier(SupremeItems.MAGIC_ALTAR_MACHINE_III.getItemId())
        .setMachineRecipes(MagicAltar.getAllRecipe()).setTimeProcess(15).setProcessingSpeed(15).setCapacity(600)
        .setEnergyConsumption(300).register(sup);

    new Foundry(ItemGroups.MACHINES_CATEGORY, SupremeItems.FOUNDRY_MACHINE, RecipeType.ENHANCED_CRAFTING_TABLE,
        Foundry.RECIPE_FOUNDRY_MACHINE).setMachineIdentifier(SupremeItems.FOUNDRY_MACHINE.getItemId())
    ...
    new Foundry(ItemGroups.MACHINES_CATEGORY, SupremeItems.FOUNDRY_MACHINE_II, RecipeType.ENHANCED_CRAFTING_TABLE,
        Foundry.RECIPE_FOUNDRY_MACHINE_II).setMachineIdentifier(SupremeItems.FOUNDRY_MACHINE_II.getItemId())
    ...
    new Foundry(ItemGroups.MACHINES_CATEGORY, SupremeItems.FOUNDRY_MACHINE_III, RecipeType.ENHANCED_CRAFTING_TABLE,
        Foundry.RECIPE_FOUNDRY_MACHINE_III).setMachineIdentifier(SupremeItems.FOUNDRY_MACHINE_III.getItemId())
    ...
    new ElectricCrafter(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CRAFTER_MACHINE,
        RecipeType.ENHANCED_CRAFTING_TABLE, ElectricCrafter.RECIPE_ELECTRIC_CRAFTER_MACHINE).setMachineIdentifier(
            SupremeItems.ELECTRIC_CRAFTER_MACHINE.getItemId()).setMachineRecipes(ElectricCrafter.getAllRecipe())
        .setCapacity(1000).setProcessingSpeed(1).setEnergyConsumption(20).register(sup);

    new ElectricCrafter(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CRAFTER_MACHINE_II,
        RecipeType.ENHANCED_CRAFTING_TABLE, ElectricCrafter.RECIPE_ELECTRIC_CRAFTER_MACHINE_II).setMachineIdentifier(
            SupremeItems.ELECTRIC_CRAFTER_MACHINE_II.getItemId()).setMachineRecipes(ElectricCrafter.getAllRecipe())
        .setCapacity(5000).setProcessingSpeed(5).setEnergyConsumption(100).register(sup);

    new ElectricCrafter(ItemGroups.MACHINES_CATEGORY, SupremeItems.ELECTRIC_CRAFTER_MACHINE_III,
        RecipeType.ENHANCED_CRAFTING_TABLE, ElectricCrafter.RECIPE_ELECTRIC_CRAFTER_MACHINE_III).setMachineIdentifier(
            SupremeItems.ELECTRIC_CRAFTER_MACHINE_III.getItemId()).setMachineRecipes(ElectricCrafter.getAllRecipe())
        .setCapacity(15000).setProcessingSpeed(15).setEnergyConsumption(300).register(sup);

    final int baseTimeVirtualAquarium = supremeOptions.getBaseTimeVirtualAquarium();

    new VirtualAquarium(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_AQUARIUM_MACHINE,
    ...
    new VirtualAquarium(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_AQUARIUM_MACHINE_II,
    ...
    new VirtualAquarium(ItemGroups.MACHINES_CATEGORY, SupremeItems.VIRTUAL_AQUARIUM_MACHINE_III,
    ...
    if (supremeOptions.isEnableItemConverter()) {
      new ItemConverter(ItemGroups.MACHINES_CATEGORY, SupremeItems.ITEM_CONVERTER_MACHINE,
          RecipeType.ENHANCED_CRAFTING_TABLE, ItemConverter.RECIPE_ITEM_CONVERTER_MACHINE).setMachineIdentifier(
              SupremeItems.ITEM_CONVERTER_MACHINE.getItemId()).setCapacity(1).setEnergyConsumption(1)
